...
input_recipe: list[str] = [
    'OG-Kush', 'Viagra', 'Addy', 'Horse Semen', 'Battery', 'Battery', 'Addy',
    'Horse Semen', 'Mouthwash'
]
...
def main():
    ...
    mixGivenRecipe(starting_recipes_map[input_recipe[0]], input_recipe[1:],
                   unittest_set)
...
def mixGivenRecipe(recipe: Recipe, ingredients: list[str],
                   unittest_set: list[str, list[str]]):
